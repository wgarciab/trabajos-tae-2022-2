...
El cluster 1 tiene los puntajes de admision mas altos, al igual que la tasa de completación de estudios, pero su tasa de admisión es la mas baja, y cuenta con pocos estudiantes y pocas ayudas del estado. Además, el costo de estudiar en universidades privadas de este grupo es excesivamente alto, y la deuda acumulada es bastante alta también. Se podría decir que es un grupo de universidades exclusivo.
...
En el cluster 2, se puede observar que hay una masiva cantidad de préstamos del estado para los estudiantes, sin embargo, las tasas de admisión y completación son bajas, al igual que el número de estudiantes. La gran cantidad de préstamos puede ser uno de los factores causantes de que haya una deuda acumulada relativamente grande entre todos los estudiantes. Las tasas de matrícula estan en un rango medio, siendo un poco mas caras las de instituciones privadas.
...
En el cluster 3, hay una masiva tasa de admisión, pero en todos los demás aspectos presenta valores muy bajos. Sus tasas de completación y número de estudiantes es muy bajo. Como punto positivo, los costos por estudiar en estas instituciones tambien son muy bajo, y tal vez por ello no se realizan muchos prestamos. Sus puntajes de admision tambien son muy bajos. Se podría decir que a estas instituciones se puede entrar muy facilmente.
...
En el cluster 4, al igual que en el caso anterior, tambien hay altas tasas de admisión y bajo número de estudiantes, pero en este caso, se presenta una mayor cantidad de deudas de los estudiantes. Los ingresos de las universidades recibidos por cada estudiante son bajos, y es un poco más caro estudiar en universidades privadas que en universidades publicas de este grupo. Los puntajes de admisión también son muy bajos.
